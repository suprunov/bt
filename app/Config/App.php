...
class App extends BaseConfig
{
     ...
     * @var string
     */
    public $baseURL = 'https://blacktyres.ru/';
     ...
     * @var string
     */
    public $sessionCookieName = 'ctccbjy';
     ...
     * @var int
     */
    public $sessionExpiration = 14 * DAY;
     ...
     * @var int
     */
    public $sessionTimeToUpdate = 20 * MINUTE;
